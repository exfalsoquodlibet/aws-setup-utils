...
def assume_role_with_mfa(username, user_account_id, role_account_id, role_name):
    ...
    Ref: https://stackoverflow.com/questions/64961558/boto3-assume-cross-account-role-with-mfa
    """
...
def temporary_connect_to_s3(temp_creds):
    ...
    Args:
        temp_creds: temporary credentials generated by assume_role_with_mfa().
...
def download_file_from_s3(s3_resource, s3_bucket, file_key, output_filepath):
    ...
    Args:
        ...
        file_key: name of the file to be downloaded, including folder name (e.g., "thisisafolder/myfile.csv")
